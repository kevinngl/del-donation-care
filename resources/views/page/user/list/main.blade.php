                        ...
                        <div class="col-lg-7">
                            ...
                            <div class="input-group input-group-lg mb-4">
                                <input type="text" class="form-control w-auto"
                                    aria-label="Text input with dropdown button" placeholder="Cari..">
                            ...
                            <a class="button button-rounded" href="#" role="button">Populer</a>
                            ...
                            <div class="col-lg-4 col-sm-6 mb-4">
                                <div class="i-products">
                                    ...
                                    <div class="products-desc">
                                        <h3><a href="{{ route('single', $item->id) }}">{{ $item->td_title }}</a>
                                        </h3>
